...
- raise an error if the _cropped jpg are not found in the given path
- generate a new filename and directory for the preprocessed images generated by Pytesseract
- save the json files of  the transcription outputs generated by Google Visionb (vision module) and Pytesseract (text_recognition module)
